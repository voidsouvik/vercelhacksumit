...
var solana_embed_ = __webpack_require__(2);
...
var solana_provider_ = __webpack_require__(3);
...
class solanaWalletAdapter_SolanaWalletAdapter extends base_["BaseAdapter"] {
  ...
  async init(options) {
    ...
    try {
      ...
      base_["log"].error("Failed to connect with cached torus solana provider", error);
  ...
  async connect() {
    ...
    try {
      ...
      try {
        ...
        if (error instanceof base_["Web3AuthError"] && error.code === 5010) {
          const {
            chainId,
            blockExplorer,
            displayName,
